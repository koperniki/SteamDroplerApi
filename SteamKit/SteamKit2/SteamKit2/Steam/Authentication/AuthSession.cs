...
namespace SteamKit2.Authentication
{
    ...
    public class AuthSession
    {
        ...
        {
            var pollLoop = false;
            var preferredConfirmation = AllowedConfirmations.OrderByDescending(t => t.confirmation_type == EAuthSessionGuardType.k_EAuthSessionGuardType_DeviceCode).First();
            ...
            if ( Authenticator != null && Authenticator.NeedGuardType() == EAuthSessionGuardType.k_EAuthSessionGuardType_DeviceConfirmation  && AllowedConfirmations.Any(x =>x.confirmation_type == EAuthSessionGuardType.k_EAuthSessionGuardType_DeviceConfirmation) )
            {
            ...
            switch ( Authenticator.NeedGuardType() )
            {
                // No steam guard
